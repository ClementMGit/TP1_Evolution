...
public class TopAttributeClassesVisitor extends AbstractCtVisitor {
    public final Map<CtClass<?>, Integer> classAttributeCount = new HashMap<>();
    ...
    public void calculateTop10Percent() {
        int topN = Math.max(1, (int) (classAttributeCount.size() * 0.1));
        topClasses = classAttributeCount.entrySet().stream()
